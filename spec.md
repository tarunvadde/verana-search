...
- the **Verana Graph** faceted-search endpoint (`POST /v4/graph/search`), as specified in [Faceted-search Queries](https://github.com/verana-labs/verana-spec/blob/main/v4/verana-graph/spec.md#faceted-search-queries) of the Verana Graph spec;
- the **Verana Indexer** Verifiable Trust Resolver (`POST /v4/verifiable-trust/resolve`, [IDX-VT-QRY-1](https://github.com/verana-labs/verana-spec/blob/main/v4/verana-indexer/spec.md#idx-vt-qry-1-resolve)), used to enrich DID hits with their ECS credential data for display.
